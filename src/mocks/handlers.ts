...
const PROVIDERS = [
  "Ingeniería y Construcciones SAS",
  "Tecnología Avanzada Ltda",
  "Servicios Logísticos Integrales",
  "Consultoría Estratégica SAS",
  "Distribuidora del Valle",
  "Automatización Industrial SA",
  "Soluciones Eléctricas SAS",
  "Transportes Rápidos Ltda",
  "Alimentos y Bebidas del Sur",
  "Mantenimiento General SAS",
  "Publicidad Digital Creativa",
  "Seguridad Privada Elite",
  "Asesoría Jurídica Corporativa",
  "Suministros de Oficina SAS",
  "Limpieza Especializada Ltda",
  "Software y Sistemas SA",
  "Materiales de Construcción SAS",
  "Logística de Última Milla",
  "Recursos Humanos Integrales",
  "Gestión Documental SAS",
];
...
export const handlers = [
  ...
  http.post("/api/orders", async ({ request }) => {
    ...
    const newOrder: Order = {
      ...
      fechaVencimiento: body.fechaVencimiento ?? new Date().toISOString(),
      estado: "BORRADOR",
    };
